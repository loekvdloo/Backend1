...
<body class="bg-gray-100 text-gray-800 min-h-screen">
    ...
    <main class="p-6 max-w-xl mx-auto">
        <div class="bg-white rounded-2xl shadow-md p-6">
            <h2 class="text-2xl font-semibold text-indigo-600 mb-4">Nieuw Product Aanmaken</h2>
            ...
            <form action="{{ route('products.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="productnaam" id="productnaam" placeholder="Naam van het product"
                        value="{{ old('productnaam') }}"
                        class="w-full mt-1 px-4 py-2 border rounded-xl focus:ring-2 focus:ring-indigo-400" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="beschrijving" id="beschrijving" placeholder="Beschrijving van het product"
